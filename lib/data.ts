...
import conmutador from "@/public/conmutador.png"
...
export const projectsData = [
    {
        title: "'Conmutador Nube' page",
        description:
            "Full-stack web app using .NET, CSS, HTML, Entity Framework, JavaScript and Azure for clients to quote prices on the companies cloud switch",
        tags: ["HTML", "CSS", "JavaScript", "Bootstrap", ".NET 7", "Entity Framework", "Azure Storage", "Azure security", "Azure Authentication"],
        imageUrl: conmutador,
